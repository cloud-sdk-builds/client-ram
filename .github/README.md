...
[`@aws-sdk/client-ram`](https://www.npmjs.com/package/@aws-sdk/client-ram/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ram@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JyRQ4bAs2+ovFs81N6wzgjHf/vDyrflRmBC4zvn7p0wrRNxCaXSWjh6DLQeRiA/p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ram": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ram@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ram@3.5.0/index.min.mjs": "sha384-JyRQ4bAs2+ovFs81N6wzgjHf/vDyrflRmBC4zvn7p0wrRNxCaXSWjh6DLQeRiA/p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ram/blob/refs/tags/3.5.0/LICENSE
```
