...
[`@aws-sdk/client-ram`](https://www.npmjs.com/package/@aws-sdk/client-ram/v/3.1050.0).
...
- @aws-sdk/client-ram - [https://cloud-sdk-builds.github.io/?sdk=client-ram](https://cloud-sdk-builds.github.io/?sdk=client-ram)
- @aws-sdk/client-ram v3.1050.0 - [https://cloud-sdk-builds.github.io/?sdk=client-ram&version=3.1050.0](https://cloud-sdk-builds.github.io/?sdk=client-ram&version=3.1050.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ram@3.1050.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u+bpqIhJK/5Fmmma00X5vrv36V7MhxlA/963K2NpU8wbbuelJpHTPnyay7CDV+Oj
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ram/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ram": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ram@3.1050.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ram@3.1050.0/index.min.mjs": "sha384-u+bpqIhJK/5Fmmma00X5vrv36V7MhxlA/963K2NpU8wbbuelJpHTPnyay7CDV+Oj"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-ram";
...
```
https://github.com/cloud-sdk-builds/client-ram/blob/refs/tags/3.1050.0/LICENSE
```
